...
public class ElementoInput   {
  ...
  @JsonInclude(JsonInclude.Include.NON_ABSENT)  // Exclude from JSON if absent
  @JsonSetter(nulls = Nulls.FAIL)    // FAIL setting if the value is null
  private BigDecimal genero = null;

  @JsonProperty("subgenero")

  @JsonInclude(JsonInclude.Include.NON_ABSENT)  // Exclude from JSON if absent
  @JsonSetter(nulls = Nulls.FAIL)    // FAIL setting if the value is null
  private BigDecimal subgenero = null;

  @JsonProperty("artista")

  @JsonInclude(JsonInclude.Include.NON_ABSENT)  // Exclude from JSON if absent
  @JsonSetter(nulls = Nulls.FAIL)    // FAIL setting if the value is null
  private BigDecimal artista = null;
  ...
  public ElementoInput genero(BigDecimal genero) { 
...
@Valid
  ...
  public ElementoInput subgenero(BigDecimal subgenero) { 
...
@Valid
  public BigDecimal getSubgenero() {  
    return subgenero;
  }



  public void setSubgenero(BigDecimal subgenero) { 
    this.subgenero = subgenero;
  }

  public ElementoInput artista(BigDecimal artista) { 
...
@Valid
  public BigDecimal getArtista() {  
    return artista;
  }



  public void setArtista(BigDecimal artista) { 
    this.artista = artista;
  }
